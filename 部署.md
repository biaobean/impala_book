...
## 2.将impala当前目录下所有.so结尾的文件都复制到lib/目录下
...
copy_dir ${HADOOP_LIB_DIR}/native

copy_dir ${IMPALA_SNAPPY_PATH}
copy_dir ${IMPALA_LZO}/build"

if [ $USE_SYSTEM_GCC -eq 0 ]; then
  copy_dir ${IMPALA_TOOLCHAIN_GCC_LIB}
fi
